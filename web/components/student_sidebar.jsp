...
<style>
    @media (max-width: 767px) {
        main[class*="ml-[220px]"] { margin-left: 0 !important; }
...
<button type="button" id="studentSidebarToggle" aria-label="Abrir menú" class="md:hidden fixed top-4 left-4 z-[60] w-11 h-11 rounded-xl bg-white border border-gray-200 shadow-sm flex items-center justify-center text-gray-700">
    <i class="fa-solid fa-bars"></i>
</button>

<div id="studentSidebarBackdrop" class="sidebar-backdrop fixed inset-0 bg-black/40 z-40 md:hidden"></div>

<aside id="studentSidebar" class="sidebar-drawer w-[220px] bg-white border-r border-gray-100 flex flex-col justify-between py-6 px-4 fixed inset-y-0 left-0 z-50 h-full transition-transform duration-300 ease-out md:translate-x-0">
    <div>
