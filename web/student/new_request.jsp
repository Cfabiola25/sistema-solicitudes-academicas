...
<aside class="w-[220px] bg-white border-r border-gray-100 flex flex-col justify-between py-6 px-4 fixed h-full z-10">
    <div>
        ...
        <div class="flex items-center gap-3 bg-gray-50 rounded-xl p-3 mb-6">
            ...
            <div>
                <p class="text-xs font-bold text-gray-800 leading-none">Nueva Solicitud</p>
                <p class="text-[10px] text-gray-400 mt-0.5">Crear formulario</p>
            </div>
        </div>
        <nav class="flex flex-col gap-1">
            ...
            <a href="<%=request.getContextPath()%>/student/new-request" class="nav-link active flex items-center gap-3 px-3 py-2.5 text-sm font-semibold text-white transition-all">
                <i class="fa-solid fa-plus text-sm w-4 text-center"></i> Nueva Solicitud
            </a>
